    ...
    if (savedpages.length!=0) {
      ...
      onValue(starCountRef, (snapshot) => {
        ...
        console.log(SH)
            ...
            // SH = d;
            console.log(SH)
        SH.forEach(({host_id,id,name,address,price,rooms,location,neighbourhood,imgs,latitude,longitude,number_of_rooms,number_of_bathrooms,furnished,gas})=>{
          ...
          if (id==savedpages[ss]) {/////////////////////////////////this should be the user id
              ...
              clip.innerHTML="<div style='width: -webkit-fill-available;'><div style=\"display: flex;\"><p lng-tag=\"apartment id: \"></p> <p>&nbsp"+id+"</p></div><p>"+name+"</p></div>"
